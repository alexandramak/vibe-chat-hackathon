...
router.post('/:chatId/participants', isGroupAdmin, asyncHandler(async (req, res) => {
...
router.post('/group', validateGroupChat);
router.post('/:chatId/participants', validateParticipant);
